...
var app = (function () {
    ...
    function create_default_slot_4(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*$$scope, last_name, first_name*/ 515) {
    ...
    // (25:1) <Button on:click={toggleMemo}>
    function create_default_slot_3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(25:1) <Button on:click={toggleMemo}>",
    		ctx
    	});
    ...
    // (29:1) <Modal body header="{first_name} {last_name}" isOpen={showMemo}>
    function create_default_slot_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(29:1) <Modal body header=\\\"{first_name} {last_name}\\\" isOpen={showMemo}>",
    		ctx
    	});
    ...
    // (30:1) <Button color="secondary" class="spacing-bot">
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(30:1) <Button color=\\\"secondary\\\" class=\\\"spacing-bot\\\">",
    		ctx
    	});
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(br0, file$2, 18, 26, 511);
    			add_location(br1, file$2, 19, 24, 542);
    			add_location(br2, file$2, 20, 18, 567);
    			add_location(br3, file$2, 21, 32, 606);
    			add_location(br4, file$2, 22, 32, 645);
    			add_location(br5, file$2, 23, 20, 672);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*$$scope, first_name, last_name, showMemo, memo, born_in, date_of_death, date_of_birth, gender*/ 767) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 46, 2, 1101);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(46:1) {#if countA > numbers.length}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const person0_spread_levels = [/*test_person_1*/ ctx[7]];
    	let person0_props = {};

    	for (let i = 0; i < person0_spread_levels.length; i += 1) {
    		person0_props = assign(person0_props, person0_spread_levels[i]);
    	}

    	person0 = new Person({ props: person0_props, $$inline: true });
    	const person1_spread_levels = [/*test_person_2*/ ctx[8]];
    	let person1_props = {};
    	...
    	person1 = new Person({ props: person1_props, $$inline: true });
    	...
    	const block = {
    		c: function create() {
    			...
    			p2 = element("p");
    			t20 = text("A is ");
    			t21 = text(/*countA*/ ctx[1]);
    			t22 = space();
    			p3 = element("p");
    			t23 = text("B is ");
    			t24 = text(/*countB*/ ctx[2]);
    			t25 = space();
    			create_component(nested1.$$.fragment);
    			add_location(button0, file, 44, 1, 1013);
    			add_location(button1, file, 48, 1, 1164);
    			attr_dev(p0, "class", "svelte-1ic1je1");
    			add_location(p0, file, 50, 1, 1243);
    			attr_dev(h1, "class", "svelte-1ic1je1");
    			add_location(h1, file, 51, 1, 1267);
    			attr_dev(a, "href", "https://svelte.dev/tutorial");
    			add_location(a, file, 53, 12, 1307);
    			attr_dev(p1, "class", "svelte-1ic1je1");
    			add_location(p1, file, 52, 1, 1291);
    			attr_dev(p2, "class", "svelte-1ic1je1");
    			add_location(p2, file, 56, 1, 1409);
    			attr_dev(p3, "class", "svelte-1ic1je1");
    			add_location(p3, file, 59, 1, 1436);
    			attr_dev(main, "class", "svelte-1ic1je1");
    			add_location(main, file, 40, 0, 932);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(main, t0);
    			mount_component(person0, main, null);
    			append_dev(main, t1);
    			mount_component(person1, main, null);
    			append_dev(main, t2);
    		...
    		p: function update(ctx, [dirty]) {
    			const person0_changes = (dirty & /*test_person_1*/ 128)
    			? get_spread_update(person0_spread_levels, [get_spread_object(/*test_person_1*/ ctx[7])])
    			: {};

    			person0.$set(person0_changes);

    			const person1_changes = (dirty & /*test_person_2*/ 256)
    			? get_spread_update(person1_spread_levels, [get_spread_object(/*test_person_2*/ ctx[8])])
    			: {};
    			...
    			if (!current || dirty & /*numbers*/ 8) set_data_dev(t10, /*numbers*/ ctx[3]);
    			if (!current || dirty & /*name*/ 1) set_data_dev(t13, /*name*/ ctx[0]);
    			if (!current || dirty & /*countA*/ 2) set_data_dev(t21, /*countA*/ ctx[1]);
    			if (!current || dirty & /*countB*/ 4) set_data_dev(t24, /*countB*/ ctx[2]);
    		},
    		i: function intro(local) {
    			if (current) return;
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('test_person_1' in $$props) $$invalidate(7, test_person_1 = $$props.test_person_1);
    		if ('test_person_2' in $$props) $$invalidate(8, test_person_2 = $$props.test_person_2);
    	};
